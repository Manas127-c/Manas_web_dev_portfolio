...
const Aboutdetails = () => {
  return (
    <div className='xl:w-[70vw] w-full h-[100vh]  mx-auto flex md:flex-row flex-col gap-10 items-center justify-center'>
          ...
          <h1 className='text-xl text-white mt-5'>Master in Computer Application (MCA)</h1>
          <h1 className='text-md text-white'>College of it and management education (2023)</h1>
          <h1 className='text-md text-white'>8.83 CGPA</h1>
          <h1 className='text-xl text-white mt-5'>Bachelor in Computer Application (BCA)</h1>
          <h1 className='text-md text-white'>Bhanja college of computer and management (2021)</h1>
          <h1 className='text-md text-white mb-10'>8.3 CGPA</h1>
