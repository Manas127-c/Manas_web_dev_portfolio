...
const Certifications = () => {
    const data=[{name:'Frontend Domination ',source:'Sheriyans coding school',image:'cetificate1.png',date:'Nov 2023 to Feb 2024'},]
  return (
    <div className='w-full xl:h-[50%] md:h-[60%] min-h-[30vh]  flex gap-10'>
